...
Load PC PrintfLoop
 ...
 <<optimised printf>> #heavily optimised printf loop, avoids call stack use entirely
...
Move return_addr PC  	%returnFromPrintf		#reads new top of stack from the stack frame
