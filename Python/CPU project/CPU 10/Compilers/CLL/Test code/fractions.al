...
Move Stack_pointer previous_stack_ptr				%add_fractions 		 	#gets a copy of the current stack pointer
SUB Stack_pointer @24 										#shift stack pointer on
Compare Stack_pointer Callstack_ptr  								#checks for a stack overflow
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer] 								#stores address to return to
Store previous_stack_ptr 4 [Stack_pointer]						#gives pointer to pop off of stack
...
ADD gp6 12 [Stack_pointer] 												#relative addressing always occurs outside of the stack frame
...
ADD gp6 8 [Stack_pointer] 												#relative addressing always occurs outside of the stack frame
Load gp0 0 [gp6] 									#Loads
 														#Push routine
Store gp0 Expression_stack [gp7] 									#stores gp0 to top of stack
ADD gp7 @4 															#increment stack pointer
...
SUB gp7 @4 															#decrement stack pointer to point to top of stack
Load gp0  Expression_stack [gp7] 									#pop into gp0
 															#compiler will work out whether gp0 is loaded or Pushed
				 											#same for gp1 and index
SUB gp7 @4
Load gp1 Expression_stack [gp7]
...
Store gp0 20 [Stack_pointer]



Load gp0 16 [Stack_pointer] 						#Recursion stack increments downwards
 														#Push routine
Store gp0 Expression_stack [gp7] 									#stores gp0 to top of stack
ADD gp7 @4 															#increment stack pointer
Compare gp7 stack_length 											#check for stack overflow
...
ADD gp6 12 [Stack_pointer]
Store gp0 0 [gp6]


Load gp0 20 [Stack_pointer] 						#Recursion stack increments downwards
 														#Push routine
Store gp0 Expression_stack [gp7] 									#stores gp0 to top of stack
ADD gp7 @4 															#increment stack pointer
Compare gp7 stack_length 											#check for stack overflow
...
if Greater then Load PC Stack_overflow_error
 				...
 				#compiled part
Goto simplify 		#needs to sub in call address
...
Move Stack_pointer previous_stack_ptr				%simplify 		 	#gets a copy of the current stack pointer
SUB Stack_pointer @16 										#shift stack pointer on
Compare Stack_pointer Callstack_ptr  								#checks for a stack overflow
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer] 								#stores address to return to
...
SUB Stack_pointer @32 										#shift stack pointer on
Compare Stack_pointer Callstack_ptr  								#checks for a stack overflow
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer] 								#stores address to return to
Store previous_stack_ptr 4 [Stack_pointer]						#gives pointer to pop off of stack
...
if Greater then Load PC Stack_overflow_error
 				...
 				#compiled part
Goto add_fractions 		#needs to sub in call address
