...
byteArray CLL.array_of_string2 4 [75, 101, 121, 0]
...
byteArray CLL.array_of_string1 10 [80, 108, 97, 105, 110, 116, 101, 120, 116, 0]
...
Move Stack_pointer previous_stack_ptr								%key_schedule
SUB Stack_pointer @26 									#OVERHEAD FOR FUNCTION key_schedule
...
StoreByte gp0 21 [Stack_pointer] 					#STORE GP0 (CHAR)
...
Pass %loopkey_schedule0entry 											#FOR LOOP
...
NOT gp0
if gp0 then Load PC loopkey_schedule0exit
...
Load PC loopkey_schedule0entry
Pass %loopkey_schedule0exit
...
Pass %loopkey_schedule1entry 											#FOR LOOP
...
NOT gp0
if gp0 then Load PC loopkey_schedule1exit

LoadByte gp0 21 [Stack_pointer] 					#LOAD GP0 (CHAR)
...
Load PC loopkey_schedule1entry
Pass %loopkey_schedule1exit
...
Move Stack_pointer previous_stack_ptr								%encrypt
SUB Stack_pointer @290 									#OVERHEAD FOR FUNCTION encrypt
Compare Stack_pointer Callstack_ptr
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer]
Store previous_stack_ptr 4 [Stack_pointer]
...
Store gp0 10 [Stack_pointer] 						#STORE GP0
...
Store gp0 278 [Stack_pointer] 						#STORE GP0
...
Store gp0 282 [Stack_pointer] 						#STORE GP0
...
Store gp0 270 [Stack_pointer] 						#STORE GP0
...
Store gp0 274 [Stack_pointer] 						#STORE GP0



Load gp0 274 [Stack_pointer] 						#LOAD GP0
...
Load gp0 278 [Stack_pointer] 						#LOAD GP0
...
Load gp0 10 [Stack_pointer] 						#LOAD GP0
...
Goto key_schedule 												#CALLING key_schedule
...
Store gp0 286 [Stack_pointer] 						#STORE GP0

Pass %loopencrypt0entry 											#FOR LOOP

Load gp0 286 [Stack_pointer] 						#LOAD GP0
...
Load gp0 282 [Stack_pointer] 						#LOAD GP0
...
NOT gp0
if gp0 then Load PC loopencrypt0exit
...
ADD gp6 270 [Stack_pointer]							#LOAD GP0 RELATIVE (CHAR)
LoadByte gp0 0 [gp6]
...
Goto generate 												#CALLING generate
...
ADD gp6 270 [Stack_pointer] 							#STORE GP0 RELATIVE (CHAR)
StoreByte gp0 0 [gp6]
...
Load PC loopencrypt0entry
Pass %loopencrypt0exit
...
SUB Stack_pointer @28 									#OVERHEAD FOR FUNCTION check_if_equal
Compare Stack_pointer Callstack_ptr
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer]
Store previous_stack_ptr 4 [Stack_pointer]
...
Goto print_hex 												#CALLING print_hex
...
Move Stack_pointer previous_stack_ptr								%generate
SUB Stack_pointer @29 									#OVERHEAD FOR FUNCTION generate
Compare Stack_pointer Callstack_ptr
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer]
Store previous_stack_ptr 4 [Stack_pointer]
...
ADD gp6 17 [Stack_pointer]							#LOAD GP0 RELATIVE (CHAR)
LoadByte gp0 0 [gp6]
...
ADD gp6 21 [Stack_pointer]							#LOAD GP0 RELATIVE (CHAR)
LoadByte gp0 0 [gp6]
...
ADD gp6 25 [Stack_pointer]							#LOAD GP0 RELATIVE (CHAR)
LoadByte gp0 0 [gp6]
...
SUB Stack_pointer @42 									#OVERHEAD FOR FUNCTION int_to_string
Compare Stack_pointer Callstack_ptr
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer]
Store previous_stack_ptr 4 [Stack_pointer]
...
if gp0 then Load PC ifint_to_string8true 									#IF ELSE STATEMENT
...
if gp0 then Load PC ifint_to_string7true 									#IF ELSE STATEMENT
...
if gp0 then Load PC ifint_to_string6true 									#IF ELSE STATEMENT
...
if gp0 then Load PC ifint_to_string5true 									#IF ELSE STATEMENT
Load gp0 @57
...
Load PC ifint_to_string5endif
Pass %ifint_to_string5true
Load gp0 @56
...
Pass %ifint_to_string5endif           

Load PC ifint_to_string6endif
Pass %ifint_to_string6true
Load gp0 @55
...
Pass %ifint_to_string6endif           

Load PC ifint_to_string7endif
Pass %ifint_to_string7true
...
if gp0 then Load PC ifint_to_string4true 									#IF ELSE STATEMENT
Load gp0 @54
...
Load PC ifint_to_string4endif
Pass %ifint_to_string4true
Load gp0 @53
...
Pass %ifint_to_string4endif           
 
Pass %ifint_to_string7endif           

Load PC ifint_to_string8endif
Pass %ifint_to_string8true
...
if gp0 then Load PC ifint_to_string3true 									#IF ELSE STATEMENT
...
if gp0 then Load PC ifint_to_string2true 									#IF ELSE STATEMENT
...
if gp0 then Load PC ifint_to_string1true 									#IF ELSE STATEMENT
Load gp0 @52
...
Load PC ifint_to_string1endif
Pass %ifint_to_string1true
Load gp0 @51
...
Pass %ifint_to_string1endif           

Load PC ifint_to_string2endif
Pass %ifint_to_string2true
Load gp0 @50
...
Pass %ifint_to_string2endif           

Load PC ifint_to_string3endif
Pass %ifint_to_string3true
...
if gp0 then Load PC ifint_to_string0true 									#IF ELSE STATEMENT
Load gp0 @49
...
Load PC ifint_to_string0endif
Pass %ifint_to_string0true
Load gp0 @48
...
Pass %ifint_to_string0endif           
 
Pass %ifint_to_string3endif           
 
Pass %ifint_to_string8endif           
