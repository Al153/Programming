...
byteArray CLL.array_of_string1 8 [97, 97, 98, 99, 98, 97, 97, 0]
...
Goto count_block_palindromes 												#CALLING count_block_palindromes
...
Move ret_addr PC
																	...
																	Scope count_block_palindromes
def length gp4
def expression_stack_ptr gp7
def ret_addr Jump
def previous_stack_ptr gp5

Move Stack_pointer previous_stack_ptr								%count_block_palindromes
SUB Stack_pointer @28 									#OVERHEAD FOR FUNCTION count_block_palindromes
Compare Stack_pointer Callstack_ptr
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer]
Store previous_stack_ptr 4 [Stack_pointer]
...
Pass %loopcount_block_palindromes0entry 											#FOR LOOP
...
NOT gp0
if gp0 then Load PC loopcount_block_palindromes0exit
...
Goto check_if_equal 												#CALLING check_if_equal
...
NOT gp0 														    #IF STATEMENT
if gp0 then Load PC ifcount_block_palindromes0endif
...
Pass %ifcount_block_palindromes0endif
...
Load PC loopcount_block_palindromes0entry
Pass %loopcount_block_palindromes0exit
