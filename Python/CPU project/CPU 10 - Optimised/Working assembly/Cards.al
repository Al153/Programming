...
#______________ Merge Piles ____________
#gp0: top_pile, gp1: bottom_pile ==> gp0: top_pile

ptr merge_piles
ptr merge_piles.loop
ptr merge_piles.return

def merge_piles.pile0 gp0
def merge_piles.pile1 gp1

def merge_piles.top0 gp2
def merge_piles.top1 gp3
def merge_piles.previous_card gp4
