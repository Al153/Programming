...
RI =((4,10,12,5,11,6,3,16,21,25,13,19,14,22,24,7,23,20,18,15,0,8,1,17,2,9),17)
RII = ((0,9,3,10,18,8,17,20,23,1,11,7,22,19,12,2,16,6,25,13,15,24,5,21,14,4),5)
RIII =((1,3,5,7,9,11,2,15,17,19,23,21,25,13,24,4,8,22,6,0,10,12,20,18,16,14),22)
RIV =((4, 18, 14, 21, 15, 25, 9, 0, 24, 16, 20, 8, 17, 7, 23, 11, 13, 5, 19, 6, 10, 3, 2, 12, 22, 1),10)
RV =((21, 25, 1, 17, 6, 8, 19, 24, 20, 15, 18, 3, 13, 7, 11, 23, 0, 22, 12, 9, 16, 14, 5, 4, 2, 10),0)
...
class Enigma:
    def __init__(self,rotor1CF,rotor2CF,rotor3CF,reflectorCF,key1,key2,key3,ring1,ring2,ring3,reflector_pos,customAlphabet):
...
while success == 0:
    try:
        R1 = input('''Please enter chosen rotors (RI - RV):
Right (fast) Rotor: ''')
        success = 1
    except NameError:
...
alphabet = input("Please place here your custom alphabet (For plugboard emulation): ")

plaintext = str(raw_input("Please enter your plain or ciphertext: "))


        
Enigma = Enigma(R1,R2,R3,refConfig,key1,key2,key3,ring1,ring2,ring3,refpos,alphabet)
Tools = Tools()
