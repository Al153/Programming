...
byteArray CLL.array_of_string19 10 [10, 9, 99, 111, 115, 116, 32, 61, 32, 0]
...
byteArray CLL.array_of_string21 9 [10, 82, 79, 85, 78, 68, 58, 32, 0]
int CLL.string21 CLL.array_of_string21
byteArray CLL.array_of_string20 10 [9, 109, 111, 100, 101, 108, 32, 61, 32, 0]
int CLL.string20 CLL.array_of_string20
byteArray CLL.array_of_string23 13 [9, 116, 101, 109, 112, 101, 114, 97, 116, 117, 114, 101, 0]
int CLL.string23 CLL.array_of_string23
byteArray CLL.array_of_string22 10 [9, 77, 111, 100, 101, 108, 32, 61, 32, 0]
int CLL.string22 CLL.array_of_string22
byteArray CLL.array_of_string25 13 [67, 82, 69, 65, 84, 69, 68, 32, 83, 69, 84, 10, 0]
int CLL.string25 CLL.array_of_string25
byteArray CLL.array_of_string24 13 [9, 103, 114, 97, 100, 105, 101, 110, 116, 32, 61, 32, 0]
...
Compare gp7 stack_length
if Greater then Load PC Stack_overflow_error
Goto function:GetGradientVector 												#CALLING GetGradientVector
...
Move previous_stack_ptr Stack_pointer
Move ret_addr PC
																	Scope GetGradientVector
def length gp4
def expression_stack_ptr gp7
def ret_addr Jump
def previous_stack_ptr gp5
Move Stack_pointer previous_stack_ptr								%function:GetGradientVector
SUB Stack_pointer @36 									#OVERHEAD FOR FUNCTION GetGradientVector
Compare Stack_pointer Callstack_ptr
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer]
Store previous_stack_ptr 4 [Stack_pointer]
...
Compare gp7 stack_length
if Greater then Load PC Stack_overflow_error
Goto function:CostFunction 												#CALLING CostFunction
SUB gp7 @4 															#POP GP0
Load gp0 Expression_stack [gp7]
Store gp0 8 [Stack_pointer] 						#STORE GP0
Load gp6 @1
...
Load gp0 0 [gp6]
Store gp0 28 [Stack_pointer] 						#STORE GP0
Pass 										%loopGetGradientVector-0entry 		#FOR LOOP
Load gp0 28 [Stack_pointer] 						#LOAD GP0
if gp0 then Load gp0 @4294967295 									#COMPARE (IS TRUE)
NOT gp0
if gp0 then Load PC loopGetGradientVector-0exit
Load gp6 @0
MUL gp6 @4 														   #INDEXING FOR @INT
ADD gp6 28 [Stack_pointer] 							#LOAD GP0 RELATIVE
Load gp0 0 [gp6]
...
ADD gp6 28 [Stack_pointer] 							#STORE GP0 RELATIVE
Store gp0 0 [gp6]
Pass 										%loopGetGradientVector-0continue
Load gp6 @1
MUL gp6 @4 														   #INDEXING FOR @INT
ADD gp6 28 [Stack_pointer] 							#LOAD GP0 RELATIVE
Load gp0 0 [gp6]
Store gp0 28 [Stack_pointer] 						#STORE GP0
Load PC loopGetGradientVector-0entry
Pass 										%loopGetGradientVector-0exit
Load previous_stack_ptr 4 [Stack_pointer] 							#RETURNING
Load ret_addr 0 [Stack_pointer]
Move previous_stack_ptr Stack_pointer
Move ret_addr PC
...
def ret_addr Jump
def previous_stack_ptr gp5
Move Stack_pointer previous_stack_ptr								%function:CostFunction
SUB Stack_pointer @32 									#OVERHEAD FOR FUNCTION CostFunction
Compare Stack_pointer Callstack_ptr
if Less then Load PC Recursion_limit_reached
Store ret_addr 0 [Stack_pointer]
Store previous_stack_ptr 4 [Stack_pointer]
...
Load gp0 0 [gp6]
Store gp0 16 [Stack_pointer] 						#STORE GP0
Pass 										%loopCostFunction-0entry 		#FOR LOOP
Load gp0 16 [Stack_pointer] 						#LOAD GP0
if gp0 then Load gp0 @4294967295 									#COMPARE (IS TRUE)
NOT gp0
if gp0 then Load PC loopCostFunction-0exit
Load gp6 @0
MUL gp6 @4 														   #INDEXING FOR @INT
ADD gp6 16 [Stack_pointer] 							#LOAD GP0 RELATIVE
Load gp0 0 [gp6]
...
ADD gp0 gp1 														#ADD
Store gp0 28 [Stack_pointer] 						#STORE GP0
Pass 										%loopCostFunction-0continue
Load gp6 @1
MUL gp6 @4 														   #INDEXING FOR @INT
ADD gp6 16 [Stack_pointer] 							#LOAD GP0 RELATIVE
Load gp0 0 [gp6]
Store gp0 16 [Stack_pointer] 						#STORE GP0
Load PC loopCostFunction-0entry
Pass 										%loopCostFunction-0exit
Load gp0 12 [Stack_pointer] 						#LOAD GP0
Store gp0 Expression_stack [gp7]									#PUSH GP0
ADD gp7 @4
Compare gp7 stack_length
