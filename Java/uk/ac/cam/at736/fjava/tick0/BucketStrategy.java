...
// This class is part of the strategy patter
public abstract class BucketStrategy {
	...
	protected abstract int getBucket(int value);

	public int[] doRadixSort(DataInputStream in, FileOutputStream out, RandomAccessFile inFile, RandomAccessFile outFile, int length) throws IOException{
		int value;
		int i;
